...
def test_pick_slot_follows_the_original_team_not_the_holder(monkeypatch):
    ...
    assert acquired["market_value"] == round(4487 * team_values.PICK_PREMIUM_THIS_YEAR), "and what it buys carries the measured premium"
...
def test_pick_falls_back_to_flat_value_when_no_tier_is_published(monkeypatch):
    ...
    assert pick["market_value"] == round(2028 * team_values.PICK_PREMIUM_LATER)   # a future year: the bigger premium
